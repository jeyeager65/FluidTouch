...
void UITabSettings::create(lv_obj_t *tab) {
    ...
    lv_obj_set_size(ssid_textarea, 360, 45);
    lv_obj_set_pos(ssid_textarea, 140, 15);
    lv_textarea_set_placeholder_text(ssid_textarea, "Enter WiFi network name");
    ...
    lv_obj_set_size(pass_textarea, 360, 45);
    ...
    lv_obj_set_size(ip_textarea, 360, 45);
    ...
    lv_obj_set_size(port_textarea, 360, 45);
...
// Settings input field event handler for keyboard
static void settings_textarea_event_handler(lv_event_t *e) {
    ...
    if (code == LV_EVENT_FOCUSED) {
        ...
        // Enable scrolling on the Settings tab
        ...
        if (keyboard != NULL) {
            ...
            // Disable scrolling on the Settings tab
...
void UITabSettings::loadSettings() {
...
void UITabSettings::saveSettings() {
